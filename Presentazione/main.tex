...
\input{sections/03_gaps}
\input{sections/04_objectives}
\input{sections/05_core_agnosticism_contract_driven}
\input{sections/06_core_oracles}
\input{sections/07_core_taxonomy}
\input{sections/08_core_image_pipeline}
\input{sections/09_validation}
\input{sections/10_conclusions_future_work}
