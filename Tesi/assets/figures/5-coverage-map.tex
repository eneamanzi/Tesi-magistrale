\begin{figure}[htbp]
  ...
  \begin{adjustbox}{max width=\textwidth}
    \begin{tikzpicture}[
        ...
        %
        % Etichetta di dominio: Altezza matematicamente bloccata a 5.2ex
        ...
        %
        % Nodi test nativi: Altezza allineata a griglia
        tst/.style={base, minimum width=3.5em, minimum height=5.2ex, font=\footnotesize\ttfamily},
        %
        % Nodi test esterni: Altezza allineata a griglia
      ...
      %% ── D5: Observability — nessun test attivo (future-work) ──────────────
    ...
    \end{tikzpicture}
  \end{adjustbox}
  \caption{Mappa di copertura (v0.1.0): test attivi per dominio e relativi esiti.}
