% ─── FIGURA: Limite strutturale del fuzzing sintattico ─────────────────────────────────
\begin{figure}[htbp]
  \centering
  \begin{adjustbox}{max width=\textwidth}
    \begin{tikzpicture}[
      ...
      % Nodo logica applicativa (non raggiungibile via A)
      ...
      \node[viaB] (b2) at (a2 |- b1) {Payload validi\\dalla \gls{OAS}};
    ...
    \end{tikzpicture}%
  \end{adjustbox}
  \caption{Limite strutturale del fuzzing sintattico applicato alle \gls{API} \gls{REST} vs.\ approccio contract-driven con \gls{OAS}.}
  \label{fig:dast-limit}
\end{figure}