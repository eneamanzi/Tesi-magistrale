\begin{figure}[htbp]
  ...
  \begin{adjustbox}{max width=\textwidth}
    \begin{tikzpicture}[
        % Distanze orizzontali a 2.5em per frecce lunghe e leggibili
        node distance=0.8ex and 2.5em,
        %
        % Stili di base: right boxes a 17.5em (salvano la singola riga di SecurityClient)
        ...
        %
        % text width a 6.5em per costringere i bordi ad allinearsi perfettamente
      ...
      % Ripristinato l'ancoraggio midway corretto per centrare perfettamente la radice
      ...
      % Xshift a 1.25em per spezzare a metà il corridoio orizzontale da 2.5em
    ...
    \end{tikzpicture}
  \end{adjustbox}
  \caption{Gerarchia delle 11 eccezioni custom (D4.P4): bloccanti (Fasi~1--4), recuperate (Fasi~5--6) e \gls{CLI}, tutte da \texttt{ToolBaseError}.}
