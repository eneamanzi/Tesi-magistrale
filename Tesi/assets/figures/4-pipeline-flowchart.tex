\begin{figure}[htbp]
  ...
  \begin{adjustbox}{max width=\textwidth}
    \begin{tikzpicture}[
        % Distanza orizzontale ridotta a 4em per assorbire lo spostamento a destra
        ...
        %
        % Stili Errori (Colonna Destra) - Ridotti a 11.5em come richiesto
      ...
      %% ── ETICHETTE DI GRUPPO (Spostate a sinistra) ──────────────────────────
    ...
    \end{tikzpicture}
  \end{adjustbox}
  \caption{Pipeline a sette fasi: startup bloccante (Fasi~1--4) ed esecuzione non bloccante (Fasi~5--7).}
