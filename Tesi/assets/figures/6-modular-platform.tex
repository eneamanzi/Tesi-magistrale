\begin{figure}[htbp]
  ...
  \begin{adjustbox}{max width=\textwidth}
    \begin{tikzpicture}[
        ...
        %
        % Moduli Satelliti
        active/.style={base, fill=green!10, draw=green!50!black, minimum width=7em},
        planned/.style={base, fill=gray!4, draw=gray!40, dashed, minimum width=7em, font=\small\itshape},
        %
        % Stili Frecce
      ...
      % Modulo attivo (Sopra)
      \node[active, above=of core] (rest) {\textbf{REST (\gls{OAS})}\\{\scriptsize (attivo)}};
