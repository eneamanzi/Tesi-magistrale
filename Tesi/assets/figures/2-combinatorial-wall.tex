...
\begin{figure}[ht]
  ...
  % all'uso di \footnotesize come font di base.
  % L'uso di \makebox[\textwidth][c] forza la centratura assoluta rispetto 
  % alla pagina, annullando lo slittamento a destra dovuto a micro-sbordamenti.
  \makebox[\textwidth][c]{%
    \begin{tikzpicture}[
