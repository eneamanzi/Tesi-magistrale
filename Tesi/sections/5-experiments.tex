...
\begin{table}[ht]
  ...
  \begin{tabularx}{\textwidth}{l l X}
    ...
    \bottomrule
    tati dell'analisi statica sul codebase AP\end{tabularx}
...
Il dato di \texttt{mypy} merita un approfondimento architetturale, perché trascende la semplice metrica di qualità del codice. La proprietà \hyperref[subsec:dual-layer-type-safety]{D6.P3} (Sezione~\ref{subsec:dual-hierarchy}% \footnote{La Sezione~\ref{subsec:dual-hierarchy} del Capitolo~\ref{chap:implementation} tratta la dual test hierarchy; \hyperref[subsec:dual-layer-type-safety]{D6.P3} è la proprietà distinta della dual-layer type safety, il cui locus è in \texttt{pyproject.toml} e \texttt{src/core/models/}.}) formalizza un sistema di type enforcement a due strati indipendenti con copertura complementare.
