...
- [X] 4.2.3 Invarianti di TestResult a Livello di Tipo (D4.P9) `[Stato: OK]`

### 4.3 Architettura dei Test Nativi e Contratto BaseTest
- [X] 4.3.1 Gerarchia Duale BaseTest / ExternalToolTest (D1.P4) `[Stato: OK]`
- [X] 4.3.2 Auth Abstraction Layer e Idempotenza dei Token (D2.P5) `[Stato: OK]`
- [X] 4.3.3 Tracciabilità Normativa e Distinzione Finding/InfoNote (D5.P1, D5.P2) `[Stato: OK]`
- [X] 4.3.4 Safe HTTP Probing Policy e Oracle a Tre Esiti (D4.P7) `[Stato: OK]`
- [X] 4.3.5 Teardown Best-Effort in Ordine LIFO (D4.P6) `[Stato: OK]`
...
- [X] 4.4.3 Classificazione A/B, Path Seed e Catalogo dei Payload (D2.P6, D2.P7, D2.P8) `[Stato: OK]`
